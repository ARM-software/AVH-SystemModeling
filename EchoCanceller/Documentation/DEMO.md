...
If we look at the uncleaned signal mixing the echo and the yes/no, we can't see a lot. The noise and signal have roughly same amplitude and the signal, after propagation through the room, has a low amplitude.
